/*
 * ────────────────────────────────────────────────────────────────────────────────
 * Project: Game Main Menu UI
 * Description: A visually enhanced main menu interface for launching different 
 *              seasonal game themes with button interactions and background visuals.
 *
 * Created by: Luke KIM / KIM JUN YOUNG
